...
```{r}
library(readxl)
Googl_Stock_Prices_252 <- read_excel("/Users/sammarino/Downloads/Googl_Stock_Prices_252.xlsx")
summary(Googl_Stock_Prices_252) 
```
...
```{r}
close_price <- Googl_Stock_Prices_252$Close
date_price <- Googl_Stock_Prices_252$Price
